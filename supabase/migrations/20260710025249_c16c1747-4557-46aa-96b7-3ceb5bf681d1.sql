...
BEGIN
  ...
  IF v_exists IS NULL THEN
    INSERT INTO public.clients (owner_id, tenant_id, name, cpf, phone, whatsapp, email, city, address, notes, origem, status)
    VALUES (v_owner, NEW.tenant_id, NEW.name, NEW.cpf, NEW.phone, NEW.whatsapp, NEW.email, NEW.city, NEW.event_address, NEW.notes, 'link_orcamento', 'novo_cliente');
  END IF;
